...
<template>
	...
	>
		...
		>
			...
			>
				<div
					class="w-12 h-12 rounded-full flex items-center justify-center bg-[var(--accent)] text-black shadow-lg shadow-amber-500/25 transition-transform hover:scale-105"
				>
